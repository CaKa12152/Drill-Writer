...
def properties_tab(event):
    ...
    if properties_tab != 1:
        global selected_marcher_label, x_value_marcher, y_value_marcher, properties_tab_items, tab
        ...
        x_value_marcher.place(x=110, y=85)
        ...
        y_value_marcher.place(x=110, y=140)
